function h = plot_with_bar(x, y, sy, varargin)
% PLOT_WITH_BAR Plot with symmetric error bars (Octave compatible)
%
% Usage:
%   h = plot_with_bar(x, y, sy)
%   h = plot_with_bar(x, y, sy, 'PropertyName', PropertyValue, ...)
%
% Inputs:
...
%   y = sin(x);
%   sy = 0.1 * ones(size(x));
%   h = plot_with_bar(x, y, sy, 'color', 'r', 'marker', 's');
%
% See also: semilogx_with_bar, semilogy_with_bar, loglog_with_bar
